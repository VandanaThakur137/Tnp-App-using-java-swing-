...
public class PtViewAllAvailableJobsFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PtViewAllJobFrame
     */
...
ex.printStackTrace();
    ...
    private void initComponents() {
        ...
        tblAllJobs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Job-Id", "Job Title", "Skills", "Skills Required"
            }
        ) {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/new/viewAllJob.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 3, 16)); // NOI18N
        jLabel3.setText("All Job's -");

        btnApply.setBackground(new java.awt.Color(153, 204, 255));
        btnApply.setFont(new java.awt.Font("Tahoma", 3, 16)); // NOI18N
...
rs.setJobId((String)tblAllJobs.getValueAt(row,0).toString().trim());
