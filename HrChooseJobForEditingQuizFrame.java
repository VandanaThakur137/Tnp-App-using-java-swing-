...
ex.printStackTrace();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/new/removeJob.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Tahoma", 3, 16)); // NOI18N
        jLabel3.setText("All Job For Editing Quiz -");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(185, 185, 185)
                .addComponent(btnEditQuiz, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnEditQuizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditQuizActionPerformed
       int row=tblAllJobs.getSelectedRow();
        if(row==-1){
JOptionPane.showMessageDialog(null,"Please Select A Row Firs!!", "No Row Selected!!",JOptionPane.WARNING_MESSAGE);
            return;
        }
